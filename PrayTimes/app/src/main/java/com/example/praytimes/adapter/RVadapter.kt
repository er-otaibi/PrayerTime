...
import com.example.praytimes.activities.MainActivity
...
class RVadapter (private val activity: MainActivity, private var list: ArrayList<CityPrayTime>):  RecyclerView.Adapter<RVadapter.ItemViewHolder>(){
